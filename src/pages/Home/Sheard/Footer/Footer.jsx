...
import img from '../../../../asetss/Banner/2ecf7364cd78b7222311518159a72179.jpg'

const Footer = () => {
    return (
        <div className='bg-black'>
            <footer className="footer w-[1200px] mx-auto p-10 text-white  ">
                <div>
                   <img className='w-28 h-28' src={img} alt="" />
                    <p>Pack Bags Ind. Ltd.</p>
                    <p>©Copyright |pack bags 2023 .All Right Reserved Pack-Bags 2023</p>
                </div>
                <div>
